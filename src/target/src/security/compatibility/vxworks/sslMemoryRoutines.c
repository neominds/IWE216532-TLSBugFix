...
#define SSL_MEMPOOL_NOT_AVAILABLE	0
#define SSL_MEMPOOL_AVAILABLE		1
int sslMemoryPoolStatus = SSL_MEMPOOL_NOT_AVAILABLE;
...
LOCAL STATUS sslMemoryPoolInit()
     ...
     * initializations. */
    /*taskLock(); wrkk-iwe216532*/
    if (pSSLMemoryNetPoolID)
        {
        /* taskUnlock(); wrkk-iwe216532*/
        return (OK);
        }
...
LOCAL void * sslMemoryPoolMalloc
    ...
    if (sslMemoryPoolStatus != SSL_MEMPOOL_AVAILABLE)
    {
	return(NULL);
    }
